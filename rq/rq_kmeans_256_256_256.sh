...
#SBATCH --job-name=rq_kmeans_256_256_256
#SBATCH --gres=gpu:8
#SBATCH --mem=0
...
#SBATCH --nodes=1
#SBATCH --output=rq_kmeans_256_256_256.log
#SBATCH --error=rq_kmeans_256_256_256.err
...
python rqkmeans_faiss.py \
      ...
      --output_root /mnt/lustre/metavmds0lstre/data/rankagi/external_dataset/minionerec/rankagi_output_v2_train_256_256_256.json \
      --test_data /mnt/lustre/metavmds0lstre/data/rankagi/external_dataset/minionerec/rankagi_output_v2_item_text_eval.npy \
      --test_data_output /mnt/lustre/metavmds0lstre/data/rankagi/external_dataset/minionerec/rankagi_output_v2_eval_256_256_256.json \
      --num_levels 3 \
      --codebook_size 256
